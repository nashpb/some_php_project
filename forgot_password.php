...
<body class="back-img">
    ...
    async function validation(event) {
        ...
        if(checkEmail() && mobileNumber())
        {
            ...
            const response = await fetch("actions/registration/reset_password.php",
            {
                method: "POST",
                headers: {
            ...
            switch(data){
                ...
                break;
                case '!mismatch!':
                alert('USERNAME, EMAIL AND PHONE NUMBER DO NOT MATCH')
                break;
                case '!error!':
                alert('SOMETHING WENT WRONG!');
                break;
                case '!success!':
                alert('PASSWORD RESET!! NEW PASSWORD IS FIRST 4 Digits of your email and last four digits of your mobile number! For example if your email is abcd@gmail.com and mobile number is 9123456789 then your new password is abcd6789.');
